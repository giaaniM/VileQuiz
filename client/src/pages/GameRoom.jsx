...
function GameRoom() {
    ...
    return (
        <div className="bg-primary overflow-hidden relative" style={{ minHeight: "var(--screen-h)" }}>
            {/* EXIT BUTTON */}
            <button
            ...
            <AnimatePresence mode="wait">
                ...
                {(status === 'loading' || status === 'starting') && (
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className="flex flex-col items-center justify-center text-white" style={{ height: "var(--screen-h)" }}
                    >
                ...
                {status === 'countdown' && (
                    <motion.div
                        key="countdown"
                        className="flex items-center justify-center text-white" style={{ height: "var(--screen-h)" }}
                    >
                        <motion.div
                            key={countdown}
                ...
                {status === 'category-reveal' && categoryReveal && (
                    <motion.div
                        ...
                        className="flex items-center justify-center p-8" style={{ height: "var(--screen-h)" }}
                    >
                ...
                {status === 'results' && results && currentQuestion && (
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className="flex flex-col items-center justify-center text-white px-8 py-6" style={{ height: "var(--screen-h)" }}
                    >
                ...
                {status === 'calculating' && (
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className="flex flex-col items-center justify-center text-white text-center" style={{ height: "var(--screen-h)" }}
                    >
                        <div className="text-8xl mb-8 animate-bounce">🧮</div>
                ...
                {status === 'leaderboard' && (
                    <motion.div
                        ...
                        className="flex flex-col items-center justify-center text-white px-6" style={{ height: "var(--screen-h)" }}
                    >
