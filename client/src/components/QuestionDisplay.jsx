        ...
        <div className="w-full max-w-6xl mx-auto p-4 flex flex-col h-screen max-h-[90vh]">
            ...
            <div className="flex justify-between items-center mb-2 md:mb-4">
                ...
                <div className="flex items-center gap-2 md:gap-3">
                    ...
                    <span className="text-sm md:text-lg text-white/50 font-bold uppercase font-nunito">sec</span>
                </div>
            </div>
            ...
            {/* Options Grid */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 shrink-0">
